...
class UsiOption {
 public:
   ...
   * @param dummy ダミー値
   */
  UsiOption(std::string default_value, int dummy)
      : str_value_(default_value),
        str_default_value_(default_value),
        default_value_(0),
        min_(0),
        max_(1),
        type_(kString) {
  ...
  std::string str_default_value() const {
