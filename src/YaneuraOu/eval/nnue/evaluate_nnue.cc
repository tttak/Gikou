...
bool g_load_eval_completed = false;
...
void load_eval(const UsiOptions& usi_options) {
  NNUE::Initialize();
...
#endif
  {
    ...
    const std::string dir_name = usi_options["EvalDir"].string();
